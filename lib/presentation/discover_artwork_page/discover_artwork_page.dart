    ...
    mediaQueryData = MediaQuery.of(context);
     return GetBuilder<DiscoverArtworkController>(
       ...
       builder:(controller) {
         ...
         if (controller.discoverArtworkData.isEmpty) {
           return Center(child: Text("No artworks found", style: CustomTextStyles.bodyMediumGray700));
         }
         return GridView.builder(
           ...
           itemBuilder: (context, index) {
             ...
             return GestureDetector(
               onTap: (){
                 Get.toNamed(AppRoutes.artworkPostScreen, arguments: model.docId);
               },
