                           ...
                           child: Padding(
                               ...
                               child: Column(
                                   ...
                                   children: [
                                                   ...
                                                   PopupMenuButton<PopupmenuItemModel>(
                                                     ...
                                                     <PopupMenuEntry<PopupmenuItemModel>>[
                                                       PopupMenuItem<PopupmenuItemModel>(
                                                           ...
                                                           },controller.getArtWorkPopupList[0].icon, controller.getArtWorkPopupList[0].title!)
                                                       ),
                                                       PopupMenuItem<PopupmenuItemModel>(
                                                           child: popupmenuItemFormate((){
                                                           },controller.getArtWorkPopupList[1].icon, controller.getArtWorkPopupList[1].title!)
                                                       ),
                                                       PopupMenuItem<PopupmenuItemModel>(
                                                           child: popupmenuItemFormate((){
                                                             Get.back();
                                    ...
                                    Text("msg_the_photo_size_for".tr,
                                    ...
                                    Container(
                                        ...
                                        child: Text(
                                            ...
                                            style: CustomTextStyles
                                                ...
                                                .copyWith(height: 1.50))),
                                    SizedBox(height: 16.v),
                                    Text("lbl_cfg_scale".tr,
                                        style: theme.textTheme.titleMedium),
                                    SizedBox(height: 19.v),
                                    CustomTextFormField(
                                        controller: controller
                                            .seednumberoneController,
                                        hintText: "lbl_9".tr),
